        ...
        <Layout>
            ...
            <form onSubmit={saveCategory} >
                <div className="flex gap-1">
                    <input type="text" placeholder={'Category name'} onChange={ev => setName(ev.target.value)}
                        value={name} />
                ...
                <div className="flex gap-1">
                    {editedCategory && (
                        <button type="button" onClick={() => { setEditedCategory(null); setName = ''; setParentCategory(''); setProperties([]); }} className="btn-default">Cancel
                                        ...
                                        <td>
                                            <div className="">
                                                ...
                                                <button
                                                    ...
                                                    className=" bg-red-500 text-white px-4 py-1 rounded-md">Delete</button>
                                            </div>
